...
namespace Ex03.GarageLogic
{
    public class MotorcycleAdditionalFeatures : VehicleAdditionalFeatures
    {
        ...
        public override void SetAdditionalFeatures(List<object> i_Parameters)
        {
            ...
            m_VehicleParameters["Engine Volume"] = i_Parameters[1];
        }

        public eLicenseTypes LicenseType
        {
            get { return (eLicenseTypes)m_VehicleParameters["License Type"]; }
        }

        public int EngineVolume
        {
            get { return (int)m_VehicleParameters["Engine Volume"]; }
        }
    }
}
